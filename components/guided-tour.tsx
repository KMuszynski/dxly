...
const TourOverlay: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-[9998] pointer-events-auto">
      <div className="fixed inset-0 bg-black/50 z-[9999] backdrop-blur-sm pointer-events-auto" />
      <div
        className="fixed rounded-xl pointer-events-none transition-all duration-300 ease-out z-[10001] ring-2 ring-brand ring-offset-2 ring-offset-background bg-background/90 shadow-lg"
...
const GlobalTourPopover: React.FC = () => {
  ...
  return (
    <div
      ...
      style={popoverStyle}
    >
      <Card className="border-2 border-brand/30 backdrop-blur-xs shadow-2xl">
        ...
        <CardContent className="pt-0">
          ...
          <div className="flex items-center justify-between">
            <div className="flex gap-2 ml-auto">
              ...
              >
                {t('tour.buttons.skip', 'Skip Tour')}
              </Button>
              {!isFirstStep && (
                <Button variant="outline" size="sm" onClick={prevStep}>
                  <ChevronLeft className="h-4 w-4 mr-1" />
                  {t('tour.buttons.back', 'Back')}
                </Button>
              )}
              <Button size="sm" onClick={nextStep} className="bg-brand text-white hover:bg-brand/90">
                {isLastStep ? t('tour.buttons.finish', 'Finish') : t('tour.buttons.next', 'Next')}
...
const TourStepComponent: React.FC<{
  ...
  return (
    <div
      ...
      className={isCurrentStep ? "relative z-[10001]" : "relative"}
    >
      {children}
    </div>
  )
