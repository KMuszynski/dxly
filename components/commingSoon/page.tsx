      ...
      <div className="text-center mx-0 w-full">
        ...
        >
          ...
          <div className="relative z-20 flex flex-col items-center justify-center h-full px-10 pt-16">
            ...
            <p className="text-xxl text-gray-200 mb-4 max-w-4xl text-center">
              {t("body.subtitle")}
            </p>
            <button
              onClick={() => router.back()}
              className="bg-[#5a189a] text-white px-4 py-2 rounded-md border border-gray-700 hover:bg-[#5a189a]/90 flex items-center gap-2 mx-auto"
            >
